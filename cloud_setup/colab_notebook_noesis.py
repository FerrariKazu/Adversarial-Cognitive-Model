#!/usr/bin/env python3
"""
Colab Notebook — RHAN-Next Stages 1-3 Execution
=================================================
...
The Stage 1 blocks below (Steps 5-7c) are the executable validated record
and DEFAULT OFF (Step 4 toggles) — flip one only to deliberately re-run
that step; re-runs are resume-gated and skip-if-complete protected.
