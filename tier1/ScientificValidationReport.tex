...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{tier1/results/plots/timeline.pdf}
...
\textbf{RHAN-Large (Ours)} & \textbf{55.6} & \textbf{52.6} & \textbf{28.1} & \textbf{11.3} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/classical_comparison.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/rhan_vs_robustbench.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/robustness_vs_params.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{tier1/results/plots/radar_chart.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/accuracy_vs_eps.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/representation_statistics.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{tier1/results/plots/attention_stability_vs_eps.pdf}
