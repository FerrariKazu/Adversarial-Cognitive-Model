"""
Structural consistency assertion — PORTED VERBATIM from Gen-0.
================================================================================

Source: scripts/consistency_assert.py (the STL-10 project's Gen-0 code),
ported per MASTER_PLAN Part 5 (PORT VERBATIM — "Non-negotiable given its
history"). Only this module docstring and the namespace differ from the
source; every function body is carried unchanged.
...
script in RHAN-NXA MUST, before writing any Summary Table, assert that
...
Usage (every report generator):
    ...
    from noesis_vision.core.consistency_assert import (
        assert_table_matches_csv, assert_donor_rows_byte_identical)
