...
Reads CIFAR-10 directly from cached HF parquet files — no network access."""
...
def main():
    ...
    # Read from cached parquet directly
    ...
    del imgs, labels  # free CPU memory
