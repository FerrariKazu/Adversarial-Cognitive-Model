...
Combines all proven components from RHAN-v5:
  1. Convolutional stem with residual connections (local smoothing)
  2. Patch tokenisation + positional encoding
...
STL-10 specific adaptations:
  - 4th stem layer: 96×96 → 12×12 (144 spatial tokens)
  - Gaussian kernel sigma: 3.0 (vs 1.5 for CIFAR-10)
  - Positional embeddings: (1, 145, 512) for 144 patches + CLS
  - STL-10 normalization constants

NO VAE. NO generative prior. Just the proven architecture.
"""
...
class ConvStemUnified(nn.Module):
    """Four-layer convolutional stem for 96x96 STL-10 images."""
    ...
    def __init__(self):
        ...
        # Layer 4: NEW for STL-10 — 24×24 → 12×12
        self.conv4 = nn.Sequential(
            nn.Conv2d(512, 512, kernel_size=3, stride=2, padding=1, bias=False),
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=True),
        )
        # Residual shortcut: 3→512, stride=8 total
...
class RHANUnified(nn.Module):
    ...
    Based on proven v5 architecture. No VAE, no generative prior.
    """
...
if __name__ == '__main__':
    ...
    print("RHAN-UNIFIED forward pass: OK")
