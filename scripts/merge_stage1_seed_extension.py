    ...
    prov = {
        ...
        "seed_extension": {
            ...
            "note": ("8-seed merged verdict: seeds %s (main) + %s (extension) "
                     "at eps=0.094, both PGD-50 and PGD-100 legs, same "
                     "checkpoints/protocol. Extension rows were generated by "
                     "eval_full_epsilon_sweep.py (the frozen sweep) because "
                     "eval_rhan.py enforces a >=5-seed floor by design."
